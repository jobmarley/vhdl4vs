...
namespace MyCompany.LanguageServices.VHDL
{
	...
	/// </summary>
	[Guid("2E903EF5-5D9F-4B6E-A118-19FE8C7A676A")]
	public sealed class HDLXmlEditorFactory
		: IVsEditorFactory, IDisposable
	{
		...
		public HDLXmlEditorFactory()//VsTemplateDesignerPackage package)
		{
			//editorPackage = package;
		}

		#region IVsHDLXmlEditorFactory Members
		...
		// of view implementation that an IVsHDLXmlEditorFactory can create. 
		//
		...
		/// IVsHDLXmlEditorFactory.CreateEditorInstance. If the environment is unable to instantiate the document data 
						...
						out int pgrfCDW)
		{
			...
			pguidCmdUI = new Guid("2E903EF5-5D9F-4B6E-A118-19FE8C7A676A");
			pgrfCDW = 0;
			...
			HDLXmlEditorPane NewEditor = new HDLXmlEditorPane(editorPackage, pszMkDocument, textBuffer);
