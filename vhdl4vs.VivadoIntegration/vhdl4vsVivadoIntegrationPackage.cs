...
namespace vhdl4vs.VivadoIntegration
{
	...
	[ProvideEditorExtension(typeof(HDLXmlEditorFactory), ".bd", 65535,
			  //ProjectGuid = VHDLProjectTypeGuidString,
	...
	public sealed class vhdl4vsVivadoIntegrationPackage : AsyncPackage
	{
		...
		/// <summary>
		/// VHDLVivadoIntegrationPackage GUID string.
		/// </summary>
		public const string PackageGuidString = "721ad204-e738-404c-bf2a-0c60bec0f3fe";
